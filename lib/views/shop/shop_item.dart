...
class ShopItem extends StatefulWidget {
  const ShopItem({Key? key, required this.item, required this.itemClickFunction,this.showFlicker = false}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Expanded(
      child: GestureDetector(
        onTap: () {itemClicked();},
        child: widget.showFlicker ? FlickerAnimation(iconPath: Container(
